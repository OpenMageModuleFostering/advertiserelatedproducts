...
class Advertise_RelatedProducts_Model_Config extends Varien_Object
{
    ...
    const PRODUCT_COUNT =    'advertise_relatedproducts_options/advertise_related_products/advertise_prod_count';
    const UPSELL_HEADING  =  'advertise_relatedproducts_options/advertise_related_products/advertise_upsell_text';
